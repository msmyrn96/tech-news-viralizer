function scoreStyle(score: number): string {
  if (score >= 80) return 'text-red-400 bg-red-950/60 border-red-800/60';
  if (score >= 60) return 'text-orange-400 bg-orange-950/60 border-orange-800/60';
  if (score >= 40) return 'text-amber-400 bg-amber-950/60 border-amber-800/60';
